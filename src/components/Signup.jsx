...
<div className='w-full h-screen  flex flex-col justify-center items-center  lg:grid-cols-2'>
       {/* <img className='fixed hidden lg:block inset-0 h-screen object-cover  z-[-1]' src={period}
       alt={period} /> */}
...
<h2 className='mb-20 text-gray-500 text-sm md:text-lg lg:text-lg'>Already have an account? <a className='text-[#f9a826]' href='/signin'>LogIn</a></h2>
  ...
  alt={avatar}/>
    ...
    <div class="mb-6 border-b border-[#f9a826]"> 
      ...
      <input class=" appearance-none bg-transparent border-none rounded w-full py-2 px-7 text-red-400 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="   Username  " />
    </div>
    <div class="mb-6 border-b border-[#f9a826]">
